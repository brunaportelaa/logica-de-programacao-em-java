    ...
    public static void main(String[] args) {
        ...
        switch (operacao) {
            case 1:
                ...
                Printer.print(Calculadora.adicionar(parcelaUm, parcelaDois));
                break;
            case 2:
                ...
                System.out.println("O resultado da operação é: " + Calculadora.subtrair(aditivo, subtrativo));
                break;
            case 3:
                ...
                System.out.println("O resultado da operação é: " + Calculadora.multiplicar(fatorUm, fatorDois));
                break;
            case 4:
                ...
                Printer.print(Calculadora.dividir(dividendo, divisor));
                break;
            case 5:
                int numero = Leitor.lerInt("Informe um valor para o número:");
                Printer.print(Calculadora.fatorial(numero));
                break;
            case 6:
                int base = Leitor.lerInt("Informe um valor para a base");
                int expoente  = Leitor.lerInt("Informe um valor para o expoente:");
                System.out.println("O resultado da operação é: " + Calculadora.exponenciacao(base, expoente));
                break;
            default:
